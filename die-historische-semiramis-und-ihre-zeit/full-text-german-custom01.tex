...
\usepackage[top=68mm, bottom=85mm, outer=50mm, inner=50mm]{geometry}
...
\begin{document}
\bfseries
\AddToShipoutPictureBG{\includegraphics[width=\paperwidth,height=\paperheight]{assyrianstele1.jpg}}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures-trans/Figure-007.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures-trans/Figure-030.png}
